...
```jsonc
{
  ...
  "codex_start_cmd": "codex -c disable_paste_burst=true --sandbox danger-full-access",
  "codex_resume_cmd": "codex -c disable_paste_burst=true --sandbox danger-full-access resume 019b....", // 可选：缓存
